...
function writeFetcherStats(sequenceNumber, stats) {
        ...
        const put = new Promise((resolve, reject) => {
            ...
            dynamo.updateItem({
                ...
                ExpressionAttributeValues: {
                    ':userCounts': {B: zlib.gzipSync(stats[minute].userCounts)},
                    ':overallCounts': {B: zlib.gzipSync(stats[minute].overallCounts)}
                }
            }, (err, data) => {
...
function writeAggregate(compositeKey, data) {
    ...
    // all data values will be gzipped
    ...
    return new Promise((resolve, reject) => {
        ...
        attrs.forEach(attr => {
            ...
            attrValues[subValue] = {B: zlib.gzipSync(data[attr])};
        });
